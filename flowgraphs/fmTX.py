...
class fmTX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_range = qtgui.Range(0, 6.00e6, 1, 1.323e6, 200)
        self._samp_rate_win = qtgui.RangeWidget(self._samp_rate_range, self.set_samp_rate, "Sample Rate Slider", "counter_slider", float, QtCore.Qt.Horizontal)
